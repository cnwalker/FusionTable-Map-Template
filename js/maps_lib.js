...
if ( $("#cbType1").is(':checked')) searchType += "4, 12,";
if ( $("#cbType2").is(':checked')) searchType += "1,6,8,";
if ( $("#cbType3").is(':checked')) searchType += "2,3,5,7,";
if ( $("#cbType1").is(':checked')) searchType += "9,";
if ( $("#cbType2").is(':checked')) searchType += "10,11,";
